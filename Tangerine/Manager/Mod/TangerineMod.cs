...
namespace Tangerine.Manager.Mod
{
    ...
    public class TangerineMod
    {
        ...
        /// <inheritdoc cref="TangerineDebutEgg"/>
        public TangerineDebutEgg DebutEgg { get; }

        /// <inheritdoc cref="TangerineChargeFx"/>
        public TangerineChargeFx ChargeFx { get; }
        ...
        internal TangerineMod(ModInfo modInfo)
        {
            ...
            DebutEgg = new TangerineDebutEgg(Id);
            ChargeFx = new TangerineChargeFx(Id);
