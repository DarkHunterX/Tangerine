...
public class WeaponResetMaterials
{
    public Dictionary<int, int> LevelMaterials = new();
    public Dictionary<int, int> ExpertMaterials = new();
    public Dictionary<int, int> SkillMaterials = new();
    ...
    public void ComposeRewards(ref NetRewardsEntity netRewardsEntity)
    {
        ...
        foreach (var mat in ExpertMaterials)
            AddReward(ref netRewardsEntity, mat.Key, mat.Value);
        foreach (var mat in SkillMaterials)
            AddReward(ref netRewardsEntity, mat.Key, mat.Value);
